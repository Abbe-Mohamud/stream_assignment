...
public class StreamAssignment {
    ...
    public void task6(){
        ...
        Person[] result = people.stream()
                ...
                //.toArray(Person[]::new);  // can also be used
    ...
    public void task7(){
        ...
        Optional<Person> optional = people.stream()
                ...
                .findFirst();  //.findAny(); can be as well  
   ...
   /* @Test
    public void task12(){
        ...
        String[] result = people.stream()
                .filter(person -> person.getFirstName().equals(palindromes))
                .distinct()
                .sorted()
                .toArray(String[]::new);
    ...
    @Test
    public void task14(){
        LocalDate[] _2020_dates = Stream.iterate(LocalDate.ofYearDay(2020,1),localDate -> localDate.plusDays(1))
